...
import form41 from './form41.png'
import { MathJax, MathJaxContext } from "better-react-mathjax";


function TutoTensaoElastica() {
            ...
            return {
              columns: [
                ...
                rows: [
                  ...
                  {
                    linha: '2',
                    parametro:'Excentricidade de protensão',
                    unidades:'cm²',
                    clickEvent: () => testClickEvent(1),
                  },
                  ...
                  {
                    linha: '7',
                    parametro:'Valor da protensão de cálculo na seção',
                    unidades:'KN',
                    clickEvent: () => testClickEvent(1),
                  },
                  ...
                  {
                    linha: '8',
                    parametro:'Momento fletor de cálculo',
                    unidades:'KNm',
                    clickEvent: () => testClickEvent(1),
                  },
                  ],
...
Para verificar estes novos estados é necessário estabelecer o comportamento das tensões elásticas ao longo da seção transversal e então estabelecer se este estado limite de tensões é ou não atingido.
</p><p>
A calculadora "Verificação de tensões elásticas na seção" tem como objetivo permitir que o usuário determine as tensões elásticas na base e no topo da seção transversal de uma viga de concreto protendido. Para utilizar a calculadora, basta preencher os campos com os valores desejados e clicar no botão "Calcular".
</p><p>
Os valores esperados na entrada são:</p>
        <CDBContainer>
...
}; export default TutoTensaoElastica;